...
from util_dst import iterate_dst_file
...
class DialogLoader(Dataset):
    ...
    def __init__(self, tokenizer: GPT2Tokenizer, data_type: str, max_length=MAX_LEN):
    ...
    def _create_examples(self):
        ...
        for example_num, example_id in enumerate(tqdm(sorted(self.dst_data.keys()))):
            ...
            if not self.generation:
                ...
                if len(input_ids) >= self.MAX_LEN: # handle over-length example
    ...
    def collate_fn_batch(self, batch):
